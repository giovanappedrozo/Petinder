<main class="container">
        ...
        <ul class="nav nav-tabs">
            <li class="nav-item">
                    <a class="nav-link active" href="<?php echo site_url('usuarios/chats/adopt'); ?>"><?php echo $this->lang->line('Adopt'); ?></a>
            </li>
            <li class="nav-item">
                    <a class="nav-link" href="<?php echo site_url('usuarios/chats/donate'); ?>"><?php echo $this->lang->line('Rehome'); ?></a>
            </li>
        </ul>   
